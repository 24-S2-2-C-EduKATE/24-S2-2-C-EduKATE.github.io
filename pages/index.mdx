...
We are achieving this by creating STEM toys that genuinely appeal to the interests of young girls. Currently, we are developing a robotic dog that can be programmed via an app using a custom block coding language. Users will be guided through interactive lessons tailored to their individual skills before seeing the code they developed come to life on their toy.</p>
  ...
  <div className="features-container">
    <div className="content-container">
      <Features>
        <Feature index={1} href="/docs/statement-of-work">
        ...
        <Feature index={2} href="/docs/team-charter">
        ...
        <Feature index={3} href="https://github.com/orgs/24-S2-2-C-EduKATE/projects/3">
          <h3>Decision Log<br className="show-on-mobile"/></h3>
          <p className='mb-4'></p>
        </Feature>
        <Feature index={3} href="https://github.com/orgs/24-S2-2-C-EduKATE/projects/7">
          <h3>Reflection Log<br className="show-on-mobile"/></h3>
          <p className='mb-4'></p>
        </Feature>
        <Feature index={3} href="https://github.com/orgs/24-S2-2-C-EduKATE/projects/5">
          <h3>Feedback Log<br className="show-on-mobile"/></h3>
          <p className='mb-4'></p>
        </Feature>
        <Feature index={3} href="https://github.com/orgs/24-S2-2-C-EduKATE/projects/6">
